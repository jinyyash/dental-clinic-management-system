...
<!-- Mirrored from fvdthemes.com/html/dentalclinic/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Nov 2018 11:12:46 GMT -->
<head>
<meta charset="utf-8">
...
<div class="preloader" id="preloader"> <img src="<?php echo base_url();?>assets/images/preloader.gif" alt="" /> </div>
  ...
  <div class="container">
    <div class="row"> 
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        <div class="top-bar-adress"> <i class="flaticon-navigation-arrow"></i> No 35,Anagarka Darmapala Road,Matara,Srilanka </div>
      </div>
  ...
  <div class="container">
    <div class="row"> 
      ...
      <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
        <div class="header-logo"> <a href="#"><img src="<?php echo base_url();?>assets/images/logo.svg" alt="" />
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="mobile-bar-cont">
          <div class="top-menu-logo"> <a href="#"><img src="<?php echo base_url();?>assets/images/logo.svg" alt="" />
              <span class="bold600 color-child-6">
                DENTAL
              </span>
              <span class="color-child-5">
          ...
          <div class="mobile-bar">
            ...
            <div class="color-sw-open-1" id="color-sw-open-1"> <i class="fa fa-gear"></i> </div>
          </div>
        </div>
...
<div id="slider" class="slider">
  <div class="sp-slides"> 
    ...
    <!-- HEADER SLIDER ITEM -->
    <div class="sp-slide"> <img class="sp-image" src="<?php echo base_url();?>assets/css/images/blank.gif" alt=""
	        		data-src="<?php echo base_url();?>assets/assets/images/slide_01.jpg" />
    ...
    <!-- HEADER SLIDER ITEM -->
    <div class="sp-slide"> <img class="sp-image" src="<?php echo base_url();?>assets/css/images/blank.gif" alt=""
	        		data-src="<?php echo base_url();?>assets/images/slide_02.jpg" />
      <div class="container">
        <h3 class="sp-layer slider-welcome" 
                        data-position="leftCenter" data-horizontal="15" data-vertical="-370" 
                        data-show-transition="left" data-hide-transition="left"
    ...
    <!-- HEADER SLIDER ITEM -->
    <div class="sp-slide"> <img class="sp-image" src="<?php echo base_url();?>assets/css/images/blank.gif" alt=""
	        		data-src="<?php echo base_url();?>assets/images/slide_03.jpg" />
      <div class="container">
        <h3 class="sp-layer slider-welcome" 
                        data-position="leftCenter" data-horizontal="15" data-vertical="-370" 
                        data-show-transition="left" data-hide-transition="left"
    ...
    <div class="row">
      ...
      <div class="doctors-container">
        <div class="owl-doctors" id="owl-doctors"> 
          ...
          <div class="doctors-item">
            <div class="doctors-item-container">
              <div class="doctors-item-image"> <img src="<?php echo base_url();?>assets/images/doctor2.jpg" alt="" /> </div>
              <div class="doctors-item-name">Arnie Alban</div>
              <div class="doctors-item-position">Pedodontics</div>
            </div>
            <div class="doctors-item-social"> <a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-skype"></i></a> </div>
            <div class="doctors-item-button"> <a href="#bookform3" class="fancybox-1 btn btn-default">
                <span class="plus">
                  +
                </span>
                BOOK APPOINTMENT</a> </div>
          ...
          <div class="doctors-item">
            <div class="doctors-item-container">
              <div class="doctors-item-image"> <img src="<?php echo base_url();?>assets/images/doctor3.jpg" alt="" /> </div>
              <div class="doctors-item-name">Dustin Callahan</div>
              <div class="doctors-item-position">Orthodontist</div>
            </div>
            <div class="doctors-item-social"> <a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-skype"></i></a> </div>
            <div class="doctors-item-button"> <a href="#bookform4" class="fancybox-1 btn btn-default">
                <span class="plus">
                  +
                </span>
                BOOK APPOINTMENT</a> </div>
          ...
          <div class="doctors-item">
            <div class="doctors-item-container">
              <div class="doctors-item-image"> <img src="<?php echo base_url();?>assets/images/doctor4.jpg" alt="" /> </div>
              <div class="doctors-item-name">Kristin Weaver</div>
              <div class="doctors-item-position">Hygienist</div>
            </div>
            <div class="doctors-item-social"> <a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-skype"></i></a> </div>
            <div class="doctors-item-button"> <a href="#bookform5" class="fancybox-1 btn btn-default">
                <span class="plus">
                  +
                </span>
                BOOK APPOINTMENT</a> </div>
          ...
          <div class="doctors-item">
            <div class="doctors-item-container">
              <div class="doctors-item-image"> <img src="<?php echo base_url();?>assets/images/doctor5.jpg" alt="" /> </div>
              <div class="doctors-item-name">Leslie Adams</div>
              <div class="doctors-item-position">Prosthodontics</div>
            </div>
            <div class="doctors-item-social"> <a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-skype"></i></a> </div>
            <div class="doctors-item-button"> <a href="#bookform6" class="fancybox-1 btn btn-default">
                <span class="plus">
                  +
                </span>
                BOOK APPOINTMENT</a> </div>
              ...
              <div class="help t-tooltip t-left"> ?
                ...
                <div class="t-tooltip-text">
                  <div class="t-tooltip-text-body"> Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<br>
                    <a href="#" class="btn btn-primary-1 btn-sm">READ MORE</a> </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 numbers-item">
          ...
          <div class="numbers-item-title">MASTER<br>
            CERTIFICATIONS</div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="review-container">
        <div class="owl-review" id="owl-review"> 
          ...
          <!-- REVIEW ITEM -->
          <div class="review-item">
            <div class="review-item-image"> <img src="<?php echo base_url();?>assets/images/review3.jpg" alt="" /> </div>
          ...
          <!-- REVIEW ITEM -->
          <div class="review-item">
            <div class="review-item-image"> <img src="<?php echo base_url();?>assets/images/review4.jpg" alt="" /> </div>
        ...
        <div class="tips-content">
          <div class="tab-content"> 
            ...
            <div class="tab-pane fade active in tips-content-item" id="tips1">
              ...
              <div class="tips-content-item-image"> <img src="<?php echo base_url();?>assets/images/blog_author1.jpg" alt="" />
            ...
            <div class="tab-pane fade tips-content-item" id="tips2">
              ...
              <div class="tips-content-item-image"> <img src="<?php echo base_url();?>assets/images/blog_author2.jpg" alt="" />
            ...
            <div class="tab-pane fade tips-content-item" id="tips3">
              ...
              <div class="tips-content-item-image"> <img src="<?php echo base_url();?>assets/images/blog_author3.jpg" alt="" />
            ...
            <div class="tab-pane fade tips-content-item" id="tips4">
              ...
              <div class="tips-content-item-image"> <img src="<?php echo base_url();?>assets/images/blog_author4.jpg" alt="" />
            ...
            <div class="tab-pane fade tips-content-item" id="tips5">
              ...
              <div class="tips-content-item-image"> <img src="<?php echo base_url();?>assets/images/blog_author5.jpg" alt="" />
            ...
            <div class="tab-pane fade tips-content-item" id="tips6">
              ...
              <div class="tips-content-item-image"> <img src="<?php echo base_url();?>assets/images/blog_author6.jpg" alt="" />
    ...
    <div class="row">
      ...
      <div class="clients-container">
        <div class="owl-clients" id="owl-clients"> 
          ...
          <!-- CLIENTS ITEM -->
          <div class="clients-item"> <img src="<?php echo base_url();?>assets/images/clients1.jpg" alt="" /> </div>
          
          <!-- CLIENTS ITEM -->
          <div class="clients-item"> <img src="<?php echo base_url();?>assets/images/clients2.jpg" alt="" /> </div>
          
          <!-- CLIENTS ITEM -->
          <div class="clients-item"> <img src="<?php echo base_url();?>assets/images/clients3.jpg" alt="" /> </div>
          
          <!-- CLIENTS ITEM -->
          <div class="clients-item"> <img src="<?php echo base_url();?>assets/images/clients4.jpg" alt="" /> </div>
          
          <!-- CLIENTS ITEM -->
          <div class="clients-item"> <img src="<?php echo base_url();?>assets/images/clients5.jpg" alt="" /> </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 footer-matchheight">
        <div class="row"> 
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 footer-copyright">
            <div> Copyright &copy; 2016 DentalClinic Template by <a href="http://fvdthemes.com/" target="_blank">FVD Themes</a> </div>
          </div>
        </div>
      </div>
...
<div class="bookform" id="bookform2">
  ...
  <div class="bookform-right">
    <div class="doctor-info">
      <div class="doctor-info-image"> <img src="<?php echo base_url();?>assets/images/doctor1.jpg" alt="" /> </div>
      ...
      <div class="doctor-info-hours">
        <div class="doctor-info-hours-clock"> <img src="<?php echo base_url();?>assets/images/clock.png" alt="" /> </div>
...
<div class="bookform" id="bookform3">
  ...
  <div class="bookform-right">
    <div class="doctor-info">
      <div class="doctor-info-image"> <img src="<?php echo base_url();?>assets/images/doctor2.jpg" alt="" /> </div>
...
<div class="bookform" id="bookform4">
  ...
  <div class="bookform-right">
    <div class="doctor-info">
      <div class="doctor-info-image"> <img src="<?php echo base_url();?>assets/images/doctor3.jpg" alt="" /> </div>
...
<!-- =========================
    COLOR SWITHER
============================== -->
<div class="color-sw-open" id="color-sw-open"> <i class="fa fa-gear"></i> </div>
...
<!-- SCROLLSPY --> 
<script src="<?php echo base_url();?>assets/js/scrollspy.js"></script> 
...
<!-- JQUERY FORM --> 
<script src="<?php echo base_url();?>assets/js/jquery.form.html"></script> 
...
<!-- Mirrored from fvdthemes.com/html/dentalclinic/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Nov 2018 11:14:24 GMT -->
</html>