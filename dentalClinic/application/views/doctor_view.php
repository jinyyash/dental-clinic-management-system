    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="doctors-text-text">
          ...
          cepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto. </p>
        </div>
        <div class="doctors-text-doctor"> <img src="<?php echo base_url();?>assets/images/doctortext.jpg" alt="" />
          <div class="doctors-text-doctor-desc"> Our Dental Clinic is dedicated to providing the most up to date general, orthodontic and family dentistry. Our Clinic has grown to provide a world class facility for the dental cosmetics. </div>
          <div class="doctors-text-doctor-name"> <a href="#">Wyatt Esmond</a> </div>
          <div class="doctors-text-doctor-position"> Chief of Dentists </div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 footer-matchheight">
        <div class="row"> 
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 footer-copyright">
            <div> Copyrights 2016 | All rights reserved </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 footer-item footer-item-3 footer-matchheight" id="footer-item-3">
        ...
        <div class="footer-item-3-mail"> <i class="fa fa-envelope"></i> <a href="#">office@dantal.com</a> </div>
...
<!-- GOOGLE MAPS --> 
<script src="<?php echo base_url();?>assets/http://maps.googleapis.com/maps/api/js?key=AIzaSyC1N87a_NHjocaepKKcovPAYTMUkJBr9pQ&amp;language=en&amp;sensor=true"></script> 
...
<!-- Mirrored from fvdthemes.com/html/dentalclinic/doctors.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Nov 2018 11:14:42 GMT -->
</html>